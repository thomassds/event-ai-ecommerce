...
const useFormField = () => {
  ...
  if (!formContextResult || !fieldContext || !itemContext) {
    return null;
  }

  const { getFieldState, formState } = formContextResult;
...
>(({ className, children, ...props }, ref) => {
  const formField = useFormField();
  const body = formField?.error ? String(formField?.error?.message) : children;
